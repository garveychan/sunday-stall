...
[GitHub](https://github.com/garveycodes/ca-t2a2-marketplace) / [Trello](https://trello.com/b/NpLIB3x5/t2a2-marketplace-project)
...
- **Products**
  ...
  - Products have can belong to **one** `product category` at a time, defined when the product is created by the user. Inversely, each `product category` can have many different products.
...
- **Favourites**
  ...
  - This flexibility allows the table to be record **unique** instances of each `Favourite` generated by a `user`.
